...
class Dataset_JPG_Patch(Dataset_Base):
    ...
    def __getitem__(self, idx):
        ...
        try:
            ...
            # Apply transforms
            color_transform = transforms.Compose([transforms.ToTensor()])
            img_color_tensor = color_transform(image_color)
